Gereksinimler: AutoHotkey v2.0.19: https://www.autohotkey.com/download/ (Windows)  Scripti yönetici olarak çalıştırmanız gerekir.  Tuş kombinasyonlarını neden desteklemiyor? (Örneğin: Shift + F1)
